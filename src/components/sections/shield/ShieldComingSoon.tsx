...
/**
 * Pre-launch CTA band for Nexora Shield (no downloadable release yet). Mirrors
 * the ProductDownloadBand layout so the page feels complete, but offers a
 * "notify me" path and shows planned compatibility instead of a download.
 */
export function ShieldComingSoon({ product }: { product: Product }) {
        ...
        <div className="overflow-hidden rounded-panel border border-border bg-bg shadow-elevated">
          <div className="grid grid-cols-1 md:grid-cols-[1.2fr_1fr]">
            <div className="p-8 sm:p-10">
              ...
              <h2 className="mt-4 text-3xl font-black tracking-tight text-obsidian">Be first to secure your site</h2>
              <p className="mt-3 text-[16px] leading-relaxed text-text-secondary">
                Nexora Shield is in pre-launch development. Tell us you’re interested and we’ll let you
                know the moment the first downloadable release is ready.
              </p>
            ...
            <div className="border-t border-border bg-surface-soft/50 p-8 sm:p-10 md:border-l md:border-t-0">
              ...
              <dl className="mt-6 grid grid-cols-3 gap-4 rounded-card border border-border bg-bg p-4 text-center">
                <div>
                  ...
                  <dd className="mt-1 font-mono text-[15px] font-bold text-obsidian">{compat.requiresWordPress}</dd>
                </div>
                <div>
                  <dt className="text-[11px] font-bold uppercase tracking-wide text-text-muted">Target WP</dt>
                  <dd className="mt-1 font-mono text-[15px] font-bold text-obsidian">{compat.testedUpTo}</dd>
                </div>
                <div>
                  <dt className="text-[11px] font-bold uppercase tracking-wide text-text-muted">Requires PHP</dt>
                  <dd className="mt-1 font-mono text-[15px] font-bold text-obsidian">{compat.requiresPHP}</dd>
                </div>
              </dl>
            </div>
          </div>
