...
const docCategories = [
  {
    ...
    icon: Database,
    items: [
      { label: "Static Site Generator (SSG)", href: "/nexora-engine/docs/getting-started#ssg" },
      { label: "Drop-In Cache Layer", href: "/nexora-engine/docs/getting-started#drop-in" },
      { label: "HMAC Signed Loopback", href: "/nexora-engine/docs/getting-started#hmac" },
      { label: "Atomic Publication", href: "/nexora-engine/docs/getting-started#atomic" },
    ]
  },
  {
    ...
    icon: Shield,
    items: [
      { label: "Header Masking", href: "/nexora-engine/docs/getting-started#ghost" },
      { label: "Fingerprint Stripping", href: "/nexora-engine/docs/getting-started#ghost" },
      { label: "Namespace Cloaking", href: "/nexora-engine/docs/getting-started#ghost" },
      { label: "Path Normalization", href: "/nexora-engine/docs/getting-started#ghost" },
    ]
  },
  {
    title: "Registry & API",
    icon: Code2,
    items: [
      { label: "REST Endpoint Reference", href: "/nexora-engine/docs/getting-started#api" },
      { label: "WP-CLI Command Suite", href: "/nexora-engine/docs/getting-started#cli" },
      { label: "JSON Diagnostic Schema", href: "/nexora-engine/docs/getting-started#diagnostic" },
      { label: "Webhook Integrations", href: "/nexora-engine/docs/getting-started#webhooks" },
    ]
  },
  {
    title: "Deployment",
    icon: Globe2,
    items: [
      { label: "Server Requirements", href: "/nexora-engine/docs/getting-started#requirements" },
      { label: "Conflict Resolution", href: "/nexora-engine/docs/getting-started#conflicts" },
      { label: "CDN Integration", href: "/nexora-engine/docs/getting-started#cdn" },
      { label: "Rollback Safety", href: "/nexora-engine/docs/getting-started#rollback" },
    ]
  }
];
...
const technicalSpecs = [
  {
    ...
    description: "The mechanism that powers our SSG. When a publish event occurs, Nexora initiates an internal loopback request cryptographically signed with an HMAC-SHA256 signature. This ensures the portal can verify the request origin before capturing the DOM.",
          ...
          >
             ...
             <div className="flex gap-4">
                <Link
                  ...
                  className="bg-obsidian text-white px-8 py-4 rounded-xl font-bold text-[14px] flex items-center gap-3 hover:-translate-y-0.5 transition-all"
                >
                   <Terminal size={16} />
            ...
            {docCategories.map((cat, i) => (
              ...
              >
                ...
                <ul className="space-y-4">
                  {cat.items.map((item) => (
                    <li key={item.label}>
                      <Link href={item.href} className="text-[14px] font-bold text-text-muted hover:text-brand transition-colors flex items-center gap-3 group/link">
          ...
          <div className="bg-[#050B25] border border-brand/20 rounded-[48px] p-12 lg:p-20 relative overflow-hidden">
             ...
             <div className="relative z-10 grid lg:grid-cols-2 gap-20 items-center">
                <div>
                   ...
                   <Link href="/nexora-engine/docs/getting-started" className="bg-brand text-white px-10 py-5 rounded-2xl font-extrabold text-[16px] shadow-xl hover:scale-105 transition-transform inline-flex items-center gap-3">
                      Getting Started Guide
                      <Zap size={18} />
                   </Link>
                </div>
