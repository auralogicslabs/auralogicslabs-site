             ...
             <div className="lg:col-span-4 bg-white border border-border rounded-[48px] shadow-[0_48px_96px_rgba(0,0,0,0.08)] overflow-hidden">
                ...
                <div className="p-10 space-y-10">
                   ...
                   <div className="flex items-center justify-between p-6 rounded-3xl bg-surface-soft border border-border group">
                      <div>
                         <div className="text-[10px] font-bold text-text-muted uppercase tracking-widest mb-1">Mothership Sync</div>
                   ...
                   <div className="pt-6 border-t border-border">
                      <button className="w-full bg-obsidian text-white py-4 rounded-2xl font-bold text-[14px] flex items-center justify-center gap-3">
                         <Terminal size={16} />
                         NCX_CLI Command Suite
                      </button>
                   </div>
                </div>
             </div>
                ...
                <div className="bg-[#050B25] rounded-[48px] p-12 text-white shadow-2xl relative overflow-hidden">
                   ...
                   <div className="relative z-10 flex flex-col md:flex-row justify-between items-center gap-10">
                      ...
                      <div className="flex gap-4">
                         ...
                         <button className="border border-white/20 text-white px-10 py-5 rounded-2xl font-bold text-[15px] hover:bg-white/10 transition-colors">
                            Technical Docs
                         </button>
                      </div>
                   </div>
